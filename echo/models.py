...
class Node(models.Model):
    ...
    node_type = models.CharField(verbose_name='节点类型',max_length=50,choices=type,default='总部')
...
class Line(models.Model):
    ...
    line_spname = models.CharField(verbose_name='运营商',max_length=10,choices=spname,default='中国联通')
...
class Device(models.Model):
    ...
    device_status = models.CharField(verbose_name='设备状态',max_length=10,choices=status,default='启用')
...
class Task(models.Model):
    ...
    #任务的联系人
    task_contacts = models.CharField(verbose_name='联系人',max_length=100,blank=True)
    #任务状态
